...
=======
from Archived.train_apex import sac
from OppModeling.model_parameter_trans import state_dict_trans
from OOD.glod import convert_to_glod, retrieve_scores
>>>>>>> 9414b4c6cd01ea94c91192a91e5eaecb8217d3bd:Archived/SAC_apex.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='new_cpc_Toothless')
    ...
    while E.value() <= args.episode:
        ...
        # CPC latent update
        if args.cpc and e > args.cpc_batch and e % 200 == 0:
